...
import { registerTaskMaterialize } from "./commands/task-materialize.js";
import { registerTaskClose } from "./commands/task-close.js";
...
export function buildCli(): Command {
  ...
  registerTaskImport(program);
  registerTaskMaterialize(program);
  registerTaskClose(program);
